      ...
      <AnimatePresence>
        {visible && !open && (
          <motion.div
            ...
            className="fixed inset-x-0 bottom-0 z-40 flex gap-2 border-t border-line bg-surface/95 p-3 backdrop-blur-xl lg:hidden"
          ...
          >
            ...
            <a
              ...
              className="flex h-12 w-12 shrink-0 items-center justify-center border border-line text-fg"
            >
        ...
        {open && (
          ...
          >
            <button
              ...
              className="absolute inset-0 h-full w-full cursor-default bg-surface/70 backdrop-blur-md"
            />
            <motion.div
              ref={panelRef}
              role="dialog"
              ...
              className="absolute inset-y-0 right-0 flex w-full max-w-[34rem] flex-col overflow-y-auto border-l border-line bg-surface"
            >
              <div className="flex items-start justify-between gap-6 border-b border-line px-6 py-6 sm:px-8">
                ...
                <button
                  ...
                  onClick={() => setOpen(false)}
                  aria-label="Close"
                  className="flex h-10 w-10 shrink-0 items-center justify-center border border-line text-fg transition-colors hover:border-line"
                >
